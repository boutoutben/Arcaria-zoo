 ...
 */
final class Version20240704224144 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6AAB231FE5AA1B98 ON animal');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6AAB231FE5AA1B98 ON animal (id_habitat)');
